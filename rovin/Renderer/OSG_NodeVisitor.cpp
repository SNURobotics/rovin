...
rovin::Renderer::OSG_NodeVisitor::OSG_NodeVisitor()
...
void rovin::Renderer::OSG_NodeVisitor::apply(osg::Node & node)
{
	traverse(node);
}

void rovin::Renderer::OSG_NodeVisitor::apply(osg::Geode & geode)
{
...
void rovin::Renderer::OSG_NodeVisitor::setColor(const float r, const float g, const float b, const float a)
{
